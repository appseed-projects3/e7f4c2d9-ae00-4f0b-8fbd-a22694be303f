...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-14 17:27`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e7f4c2d9-ae00-4f0b-8fbd-a22694be303f.git
$ cd e7f4c2d9-ae00-4f0b-8fbd-a22694be303f
```
